...
class DexIndex extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            //         name: "mGCWD - CWD",
            //         icon: "dex_mgcwd_cwd",
            //         link: "MG921P18000_CWD",
            //         translate: {
            //             optionType: "PUT",
            //             strikePrice: "18000",
            //             expiration: "2021-09-01",
            //             optionBase: "CWD",
            //             optionQuote: "mGCWD"
            //         }
            //     }
                        ...
                        >
                            <Tab title="dex_index.tab_01">
                                ...
                                {/* <Translate
                                    ...
                                    content="dex_index.cwd_options"
                                />
                                <ul className="dex-index__list">
                                    {optionData.map((options3Obj, index) => (
                                        <DexIndexItem
                                            key={index}
                                ...
                                {/* <Translate
                                    className="dex-index__title"
                                    content="dex_index.derivative_title"
                                />
                                <ul className="dex-index__list">
                                    {derivativeData.map((derivativeAsset, index) => (
                                        <DexIndexItem
                                            key={index}
                                            itemClass="dex-item"
                                            asset_data={derivativeAsset}
                                            isOption={false}
                                            isCFD={true}
                                            isUserTradePair={false}
                                        />
